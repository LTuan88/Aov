...
function GenerateCodeToCopy(SortedResults)
    ...
    CodeToCopy = CodeToCopy .. "HackersHouse = gg.getResults(250000)\n"
    ...
    CodeToCopy = CodeToCopy .. "for index, value in ipairs(HackersHouse) do\n"
    CodeToCopy = CodeToCopy .. "\tOffsets['FirstOffset'][OffsetsIndex] = {}\n"
    CodeToCopy = CodeToCopy ..
    "\tOffsets['FirstOffset'][OffsetsIndex].address = HackersHouse[index].address + " ..
    ...
    if #SortedResults > 2 then
        ...
        CodeToCopy = CodeToCopy ..
        "\tOffsets['SecondOffset'][OffsetsIndex].address = HackersHouse[index].address + " ..
...
function ChatSupport()
    ...
    if chooseSupport == 2 then
        ...
        gg.copyText("https://t.me/Hackers_House_YT_chat_group")
    end
end
...
function FirstUserChoose()
    ...
    local MenuChoose = gg.choice(menuFirstItem, 0,
        "Get Chat Support:\nhttps://t.me/Hackers_House_YT_chat_group")
